...
public class Selectors {
    ...
    public static By firstNameEmployee = By.cssSelector("#ms-text-field-2:nth-child(1) input");
    public static By lastNameEmployee = By.cssSelector("#ms-text-field-3:nth-child(1) input");
